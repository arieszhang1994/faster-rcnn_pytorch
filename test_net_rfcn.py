...
if __name__ == '__main__':
  ...
  if args.net == 'res101':
    ...
    RFCN = resnet(imdb.classes, 50, pretrained=False, class_agnostic=args.class_agnostic)
  elif args.net == 'res152':
    RFCN = resnet(imdb.classes, 152, pretrained=False, class_agnostic=args.class_agnostic)
  else:
