# --------------------------------------------------------
# Pytorch multi-GPU RFCN
# Licensed under The MIT License [see LICENSE for details]
# Written by Jiasen Lu, Jianwei Yang, based on code from Ross Girshick
# Marked by Aries Zhang
# --------------------------------------------------------
...
from model.rfcn.resnet import resnet
...
if __name__ == '__main__':
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    save_name = os.path.join(output_dir, 'rfcn_{}_{}_{}.pth'.format(args.session, epoch, step))
    save_checkpoint({
      'session': args.session,
      'epoch': epoch + 1,
      'model': RFCN.module.state_dict() if args.mGPUs else RFCN.state_dict(),
